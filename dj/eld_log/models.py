...
class EldLog(models.Model):
    ...
    timings = models.ForeignKey(Timing, on_delete=models.CASCADE, null=True, blank=True)
    
    totle_off_duty = models.PositiveIntegerField(null=True, blank=True)
    totle_driving = models.PositiveIntegerField(null=True, blank=True)
    totle_on_duty = models.PositiveIntegerField(null=True, blank=True)
    totle_sleeper_berth = models.PositiveIntegerField(null=True, blank=True)
